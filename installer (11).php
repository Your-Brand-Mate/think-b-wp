...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230105_thinkb_dcb1c2330cd21b7a7401_20230105060313_archive.zip';
        const ARCHIVE_SIZE       = '206677943';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = 'dcb1c23-05060313';
        const SECONDARY_PACKAGE_HASH = '74c25b3-05060313';
        const VERSION            = '1.5.1';
